document.addEventListener("DOMContentLoaded", function() {
    ...
    function adicaoitem(evento) {
        ...
        inputcheckbox.addEventListener('change', function() {
            if (inputcheckbox.checked) {
                ...
                moveParaCompras(novoitem, labelcheck); // Chama a nova função ao desmarcar
            }
        });
    ...
    function moveParaCompras(item, label) {
        const listaCompras = document.querySelector('.itens-comprar');
        const listaComprados = document.querySelector('.itens-comprados');
    
        // Remove a classe riscada
        label.classList.remove('riscado');
    
        // Adiciona o item de volta à lista de compras
